...
import com.example.guestapp.model.Mechanic;
...
public class ComplaintDescriptionDialog extends Dialog implements
    ...
    public ComplaintDescriptionDialog(Activity a, Complaint complaint) {
        super(a);
        generate = a.findViewById(R.id.feedback_button);
...
//                animationView.playAnimation();
                ...
                mechanicListReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        updateDatabaseValue.put("/Users/Manager/"+complaint.getManager().getUid()+"/pendingComplaints/"+complaintId,tempComplaint);
                        ...
                        updateDatabaseValue1.put("/Users/Manager/"+complaint.getManager().getUid()+"/pendingComplaints/"+complaintId+"/mechanic/load",mechanic.getLoad()+1);
